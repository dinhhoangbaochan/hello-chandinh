...
Đầu tiên thì phải mini review một tí, tui hơi bất ngờ khi đây là một khoá mà cho tới thời điểm hiện tại tui cảm thấy là vô cùng dễ hiểu. Bổ sung thêm thì đây không phải là lần đầu tiên tui tự dựng đầu tui dậy để học Algo & DS. Tui đã từng cố gắng học rất nhiều khoá AlgoDS rồi nhưng hầu như là chỉ sau vài bài học thì tui đều bỏ cuộc. Phần lớn là do tui nuốt không có vô nhưng cũng cần phải nói thêm là mấy cái khoá tui chọn học thì 
